...
proficiency in the language, I need to successfully pass the
[Norwegian Language Test][norwegian-language-test]. The purpose of this page
is to chronicle my journey and share my experiences in learning Norwegian.

[norwegian-language-test]: https://www.kompetansenorge.no/tests/norwegian-language-test/about-the-test/
...
presentation. The minimum required level is A2 for the Permanent Residence
permit and B1 for citizenship.

(Source: [Residence Permit Requirements][residence-permit-requirements] and
[Citizenship Requirements][citizenship-requirements]).

[residence-permit-requirements]: https://udi.no/en/word-definitions/training-and-tests-in-the-norwegian-language-for-people-applying-for-a-permanent-residence-permit
[citizenship-requirements]: https://udi.no/en/want-to-apply/citizenship/citizenship-for-people-who-hold-a-residence-permit-in-norway/
...
<Tabs items={[
    ...
    <Tab>
        ...
        - Start by listening to the podcast [Sråktalk][spraktalk-podcast].
